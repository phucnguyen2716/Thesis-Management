                  ...
                  {[
                    ...
                    },
                    {
                      ...
                      subItems: [
                        ...
                        { label: 'Mạng máy tính', sublabel: 'Computer Networks', filter: 'networking' },
                        { label: 'An toàn không gian mạng', sublabel: 'Cybersecurity', filter: 'security' },
                        { label: 'Trí tuệ nhân tạo', sublabel: 'AI', filter: 'ai' },
                        { label: 'Hệ thống thông tin', sublabel: 'Information Systems', filter: 'is' },
