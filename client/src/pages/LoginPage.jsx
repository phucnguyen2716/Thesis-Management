...
const LoginPage = () => {
  ...
  return (
    <div 
      className="min-h-screen w-full flex items-center justify-center relative font-sans selection:bg-blue-100"
      style={{
    ...
    >
      {/* Subtle overlay without blur on the whole background */}
      <div className="absolute inset-0 bg-black/10"></div>

      {/* Login Card */}
      <div className="bg-white rounded-xl shadow-[0_10px_35px_rgba(0,0,0,0.15)] w-full max-w-[400px] p-10 relative z-10 mx-4">
        <div className="flex flex-col items-center mb-8">
          <div className="w-full max-w-[150px] mb-6">
            <img 
          ...
          <p className="text-gray-400 text-[11px] font-medium uppercase tracking-widest mt-1">
        ...
        <div className="space-y-4">
          <button 
            ...
            className="w-full py-2.5 px-4 bg-white border border-gray-200 rounded-lg text-sm font-medium text-gray-700 flex items-center justify-center gap-3 transition-all hover:bg-gray-50 active:scale-[0.98]"
          >
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div className="relative group">
              <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-[#003399] transition-colors">
                <User size={16} />
              </div>
              <input
                type="text"
                required
                className="w-full pl-11 pr-4 py-3 bg-gray-50/30 border border-gray-200 rounded-lg focus:bg-white focus:border-[#003399] outline-none transition-all text-[14px] placeholder:text-gray-400"
            ...
            <div className="relative group">
              ...
              <input
                ...
                required
                className="w-full pl-11 pr-11 py-3 bg-gray-50/30 border border-gray-200 rounded-lg focus:bg-white focus:border-[#003399] outline-none transition-all text-[14px] placeholder:text-gray-400"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 bg-[#003399] hover:bg-[#002b80] text-white font-semibold rounded-lg shadow-md transition-all active:scale-[0.98] disabled:opacity-70 mt-2 text-sm"
            >
