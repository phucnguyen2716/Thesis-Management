...
![User Accounts and Committees ERD](./docs/images/user_committees_erd.svg)

### 📊 Sơ đồ Quản lý Khóa luận & Đánh giá (Theses & Reviews ERD)

![Theses and Reviews ERD](./docs/images/theses_reviews_erd.svg)

### 📊 Sơ đồ các Bảng Hệ thống & Dịch vụ Bổ trợ (Supplementary & System Tables)

![Supplementary and System Tables](./docs/images/system_tables_erd.svg)
...
![Overall Architecture Diagram](./docs/images/overall_architecture.svg)
...
![Chatbot Process Flow](./docs/images/chatbot_sequence.svg)
